...
pub(super) const MSG_L1_NETWORK_HELP: &str =
    "L1 Network (ethereum mainnet, sepolia, holesky, bsc-mainnet, bsc-testnet, localhost)";
...
pub(super) const MSG_L1_NETWORK_PROMPT: &str =
    "Select the L1 network (Ethereum Mainnet/Sepolia, BSC Mainnet/Testnet, or localhost)";
